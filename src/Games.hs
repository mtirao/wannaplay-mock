...
instance ToJSON PlayerDetail where
    toJSON PlayerDetail {..} = object [
        "id" .= player_id
        ,"profile_name_url" .= profile_name_url
...
game_1 = Game status_confirmed gameDetail_1
game_2 = Game status_confirmed gameDetail_2
game_3 = Game status_confirmed gameDetail_3
game_4 = Game status_confirmed gameDetail_4
